...
The figure follows a coloring scheme preserved in de Bruijn graphs across the whole thesis --- green color for reference, red for reads, yellow and blue for marking start and end of an active region.
