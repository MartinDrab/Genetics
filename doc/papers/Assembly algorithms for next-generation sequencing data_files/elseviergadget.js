var s_tc_elseviergadget=new TagContainer('elseviergadget');
...
var s_account="elseviergadget-prod"
...
/* Setting s.trackDownloadLinks and s,trackExternalLinks to false so that from gadgets this is only done explicitly */
s.trackDownloadLinks=false
s.trackExternalLinks=false
s.trackInlineStats=false
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
/* s.linkInternalFilters="javascript:,." */
s.linkInternalFilters="javascript:elsevier.com"
...
s.setTagContainer("elseviergadget")
