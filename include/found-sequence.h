...
GEN_ARRAY_TYPEDEF(PFOUND_SEQUENCE_VARIANT);
GEN_ARRAY_IMPLEMENTATION(PFOUND_SEQUENCE_VARIANT)
...
GEN_ARRAY_TYPEDEF(PFOUND_SEQUENCE);
GEN_ARRAY_IMPLEMENTATION(PFOUND_SEQUENCE)
