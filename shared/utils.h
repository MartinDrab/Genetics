...
UTILS_TYPED_CALLOC_FUNCTION(uint16_t)
UTILS_TYPED_CALLOC_FUNCTION(uint32_t)
UTILS_TYPED_CALLOC_FUNCTION(uint64_t)
UTILS_TYPED_CALLOC_FUNCTION(int8_t)
UTILS_TYPED_CALLOC_FUNCTION(int16_t)
UTILS_TYPED_CALLOC_FUNCTION(int32_t)
UTILS_TYPED_CALLOC_FUNCTION(int64_t)
